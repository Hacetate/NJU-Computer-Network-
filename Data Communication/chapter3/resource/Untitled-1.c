...
{
    //stoptimer(A);
    printf("time interrupt,and the base now is %d\n",seq.base);
...
void send_ack(int AorB)
{   
    tolayer3(B,recvbuffer);
    printf("B send ACK%d to A\n",recvbuffer.seqnum);
}
